...
namespace Howemork4
{
    public class LuxuryItems : ITax, Output
    {
        ...
        public string Print() => $"{_type}, Название товара: {ItemName}, Цена без налога: {ItemPrice}, Цена с налогом: {ItemPrice + (ItemPrice * 20 / 100)}";
    }
}
